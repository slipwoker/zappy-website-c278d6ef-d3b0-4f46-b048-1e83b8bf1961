...
if (window.zappyContactFormLoaded) {
  (async function() {
    try {
      ...
      const zappyPayload = {
        websiteId: 'c278d6ef-d3b0-4f46-b048-1e83b8bf1961',
        name: name,
        email: email,
        subject: interest || 'Contact Form Submission',
        message: message || '',
        phone: phone || null
      };
...
alert('תודה שפנית אלינו! נחזור אליך בהקדם האפשרי.'); contactForm.reset(); }); } });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פיוניר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
